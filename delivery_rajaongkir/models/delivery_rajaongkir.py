...
class ProviderRajaongkir(models.Model):
    ...
    delivery_type = fields.Selection([('fixed', 'Fixed Price'),('rajaongkir', "RajaOngkir")], string='Provider', default='fixed', required=True)
	...
	('ninja', 'Ninja Xpress'),
    	('lion', 'Lion Parcel'),
        ('star', 'Star'),
        ('ide', 'ID Express')], default='jne', string='Courier')
    ...
    uraian_ongkir = fields.Char('Note Price')
